...
public class SelectStoreResponseDto {
    ...
    @Builder
    private SelectStoreResponseDto(Long storeId, String storeName, String storeAddress, String storeNumber,String storeNotice, List<MenuNamePrice> menus , Integer favoriteCount, List<Category> categoryList) {
